...
class NetworkDevicesVariables(base.Resource):
    ...
    def get(self, id):
        """Get variables for the given network."""
        context = request.environ.get('context')
        obj = dbapi.network_device_get_by_id(context, id)
        resp = {"variables": jsonutils.to_primitive(obj.variables)}
        return resp, 200, None
    ...
    def put(self, id):
        ...
        context = request.environ.get('context')
        obj = dbapi.network_device_variables_update(context, id, request.json)
        resp = {"variables": jsonutils.to_primitive(obj.variables)}
        return resp, 200, None
    ...
    def delete(self, id):
        ...
        context = request.environ.get('context')
        dbapi.network_device_variables_delete(context, id, request.json)
        return None, 204, None
...
class NetworkInterfaceById(base.Resource):
    ...
    def get(self, id):
        ...
        context = request.environ.get('context')
        obj = dbapi.network_interface_get_by_id(context, id)
        interface = jsonutils.to_primitive(obj)
