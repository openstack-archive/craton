...
class ProjectById(base.Resource):
    ...
    def get(self, id):
        """Get a project details by id. This is admin only function."""
        context = request.environ.get('context')
        try:
    ...
    def put(self, id):
        """Update existing project. This is admin only function."""
        return None, 200, None

    def delete(self, id):
        """Delete existing project. This is admin only function."""
        context = request.environ.get('context')
        try:
