...
class APIV1CellTest(APIV1ResourceWithVariablesTestCase):
    ...
    def test_get_cell_details(self):
        ...
        self.assert_vars_get_expected(cell_with_detail['id'], cellvars)
        self.assert_vars_can_be_set(cell_with_detail['id'])
        self.assert_vars_can_be_deleted(cell_with_detail['id'])
    ...
    def test_cell_update(self):
        ...
        self.assert_vars_get_expected(cell['id'], {})
        self.assert_vars_can_be_set(cell['id'])
        self.assert_vars_can_be_deleted(cell['id'])
    ...
    def test_cell_delete(self):
        ...
        self.assertEqual({'cell-2'},
                         {cell['name'] for cell in cells})
        self.assert_vars_get_expected(cell2['id'], {})
        self.assert_vars_can_be_set(cell2['id'])
        self.assert_vars_can_be_deleted(cell2['id'])
