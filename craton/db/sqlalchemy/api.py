...
def _add_resolved_var_filters_to_query(query, model, var_filters):
...
def _add_var_filters_to_query(query, model, var_filters):
...
def add_var_filters_to_query(query, model, filters):
    ...
    LOG.debug("TEM resolved-values: %s" % str(filters.get('resolved-values')))
    if filters.get('resolved-values'):
        return _add_resolved_var_filters_to_query(query, model, var_filters)
