...
Error response codes: invalid request(400), method not allowed(405)
...
.. code-block:: json

   {
      "cell_id": null,
      "cidr": "192.168.0.0",
      "created_at": "2017-02-14T15:59:10.034824",
      "gateway": "192.168.1.0",
      "id": 4,
      "ip_block_type": null,
      "name": "myNetwork",
...
.. code-block:: json
   ...
   [
      ...
      },
      {
         "cell_id": null,
         "cidr": "192.168.0.0",
         "created_at": "2017-02-14T16:00:16.059021",
         "gateway": "192.168.1.0",
         "id": 5,
         "ip_block_type": null,
         "name": "network2",
...
Error response codes: invalid request(400), network not found(404), method not allowed(405)
...
.. code-block:: bash
   ...
   curl -i "http://${MY_IP}:8080/v1/networks/4" \
      -XPUT \
...
.. code-block:: json

   {
      ...
      "project_id": "717e9a216e2d44e0bc848398563bda06",
      "region_id": 1,
      "updated_at": "2017-02-14T16:07:32.836515"
   }
